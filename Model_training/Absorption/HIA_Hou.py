...
if __name__ == "__main__":
    model, feature_cols, task_type, units = train_model(
        r"C:\Users\Rohith Reddy G K\Dropbox\ADMET\admet_data\Absorption\HIA_Hou\train.csv"
    )
    evaluate_model(
        model, feature_cols,
        r"C:\Users\Rohith Reddy G K\Dropbox\ADMET\admet_data\Absorption\HIA_Hou\test.csv",
        task_type=task_type
    )
