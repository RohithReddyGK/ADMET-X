...
def train_model(train_csv: str, smiles_col="Drug", label_col="Y",
                save_model_path=r"C:\Users\jahan\OneDrive\Desktop\MAJOR PROJECT\ADMET\Model_training\Absorption\Bioavailability_Ma.joblib"):
...
if __name__ == "__main__":
    model, feature_cols, task_type, units = train_model(
        r"C:\Users\jahan\OneDrive\Desktop\MAJOR PROJECT\ADMET\admet_data\Absorption\Bioavailability_Ma\train.csv"
    )
    evaluate_model(
        model, feature_cols,
        r"C:\Users\jahan\OneDrive\Desktop\MAJOR PROJECT\ADMET\admet_data\Absorption\Bioavailability_Ma\test.csv",
        task_type=task_type
    )
    df_valid = predict_and_save_binary(
        model, feature_cols,
        r"C:\Users\jahan\OneDrive\Desktop\MAJOR PROJECT\ADMET\admet_data\Absorption\Bioavailability_Ma\valid.csv",
        r"C:\Users\jahan\OneDrive\Desktop\MAJOR PROJECT\ADMET\Model_predictions\Absorption\Bioavailability_Ma.csv",
