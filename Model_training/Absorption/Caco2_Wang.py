...
def train_model(train_csv: str, smiles_col="Drug", label_col="Y",
                save_model_path=r"D:\VS Code Editor\Major Project\ADMET\Model_training\Absorption\Caco2_Wang.joblib"):
...
if __name__ == "__main__":
    model, feature_cols, task_type, units = train_model(
        r"D:\VS Code Editor\Major Project\ADMET\admet_data\Absorption\Caco2_Wang\train.csv"
    )
    evaluate_model(
        model, feature_cols,
        r"D:\VS Code Editor\Major Project\ADMET\admet_data\Absorption\Caco2_Wang\test.csv",
        task_type="regression"
    )
    df_valid = predict_and_save(
        model, feature_cols,
        r"D:\VS Code Editor\Major Project\ADMET\admet_data\Absorption\Caco2_Wang\valid.csv",
        r"D:\VS Code Editor\Major Project\ADMET\Model_predictions\Absorption\Caco2_Wang.csv",
