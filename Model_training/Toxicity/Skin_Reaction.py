# Skin_Reaction.py (Fully generalized ADMET trainer/evaluator with automatic float→int conversion)
...
if __name__ == "__main__":
    train_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\Skin Reaction\train.csv"
    valid_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\Skin Reaction\valid.csv"
    test_csv  = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\Skin Reaction\test.csv"

    save_model_path = r"D:\VS Code Editor\Major Project\ADMET\Model_training\Toxicity\Skin_Reaction.joblib"
    prediction_csv = r"D:\VS Code Editor\Major Project\ADMET\Model_predictions\Toxicity\Skin_Reaction.csv"
