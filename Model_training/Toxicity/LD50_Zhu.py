# LD50_Zhu.py (Fully generalized ADMET trainer/evaluator with automatic float→int conversion)
...
if __name__ == "__main__":
    train_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\LD50_Zhu\train.csv"
    valid_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\LD50_Zhu\valid.csv"
    test_csv  = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\LD50_Zhu\test.csv"

    save_model_path = r"D:\VS Code Editor\Major Project\ADMET\Model_training\Toxicity\LD50_Zhu.joblib"
    prediction_csv = r"D:\VS Code Editor\Major Project\ADMET\Model_predictions\Toxicity\LD50_Zhu.csv"
