# herg_central.py (Fully generalized ADMET trainer/evaluator with automatic float→int conversion)
...
if __name__ == "__main__":
    train_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\herg_central\train.csv"
    valid_csv = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\herg_central\valid.csv"
    test_csv  = r"D:\VS Code Editor\Major Project\ADMET\admet_data\Toxicity\herg_central\test.csv"

    save_model_path = r"D:\VS Code Editor\Major Project\ADMET\Model_training\Toxicity\herg_central.joblib"
    prediction_csv = r"D:\VS Code Editor\Major Project\ADMET\Model_predictions\Toxicity\herg_central.csv"
