...
const Footer=()=>{
    return (
        <footer className="bg-blue-100 dark:bg-gray-800 text-gray-800 dark:text-white py-5 shadow-md">
            <div className="max-w-6xl mx-auto px-6 flex flex:col md:flex-row items-center justify-between">
                <p className="font-bold text-sm sm:text-base md:text-lg mb-4 mb-4 md:mb-0 text-center md:text-left dark:text-gray-300">
                    © {new Date().getFullYear()} ADMET-AI Platform — All rights reserved.
                </p>

                <div className="flex space-x-6 items-center text-5xl sm:text-5xl md:test-5xl justify-center md:justify-start">
